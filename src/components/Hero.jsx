      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm
            <span className='text-[#915eff]'>&nbsp;Sayand</span>
          </h1>

          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Enthusiastic full-stack developer <br className='sm:block hidden' /> with a passion for crafting elegant and functional websites.
          </p>
        </div>
